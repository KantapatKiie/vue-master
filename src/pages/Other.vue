  ...
  <div class="card-body nav2Styles">
    <div class="container-fluid">
      <div class="col-sm-12 text-center">
        <h1 class="card-title kanitFonts3 textColerHeader">อื่นๆ</h1>
      </div>
